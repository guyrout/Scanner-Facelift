...
import PatientSearchModal26A from "./26A/PatientSearchModal26A";
...
export default function ScanPatientDetailsPage({
  ...
  return (
    <div className="flex flex-col w-full h-full min-h-0 overflow-hidden bg-page-bg relative">
      ...
      <div
        className="flex flex-1 min-h-0 min-w-0 items-start justify-center transition-[padding] duration-[360ms] ease-[var(--motion-ease-out-soft)]"
        style={{ padding: 16 }}
      >
        <div
