...
function IconBook() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      ...
      <path
        d="M18 6L3 12L18 18L33 12L18 6Z"
        stroke="black"
        strokeOpacity="0.93"
        strokeWidth="2"
      ...
      <path
        d="M9 14.5V21.5C9 23.5 13.0294 25.5 18 25.5C22.9706 25.5 27 23.5 27 21.5V14.5"
        stroke="black"
        strokeOpacity="0.93"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      {/* Tassel knot */}
      <circle cx="30.5" cy="23" r="1.6" fill="black" fillOpacity="0.93" />
    </svg>
  );
}
