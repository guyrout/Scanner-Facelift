/**
 * Scan Upper Jaw guidance — Figma 4397:220727 (Modal window- Guidance Hints).
 */
...
/** Figma GH_full_arch_upper — exported SVG (user asset). */
const STEPS_DIAGRAM = "/scan-guidance/GH_full_arch_upper.svg";
const SALIVA_ICON = "/scan-guidance/saliva-detection.svg";

/** When set, auto-open / arch-tap guidance is skipped until cleared (explicit “Don’t show again”). */
export const SCAN_UPPER_JAW_GUIDANCE_PERMANENT_KEY = "scanner26a.scanUpperJawGuidance.permanentDismiss";

export function scanUpperJawGuidanceIsPermanentlySkipped(): boolean {
  try {
    return localStorage.getItem(SCAN_UPPER_JAW_GUIDANCE_PERMANENT_KEY) === "1";
  } catch {
    return false;
  }
}

export interface ScanUpperJawGuidanceModal26AProps {
  open: boolean;
  onRequestClose: () => void;
}

export default function ScanUpperJawGuidanceModal26A({ open, onRequestClose }: ScanUpperJawGuidanceModal26AProps) {
  ...
  const handleClose = useCallback(() => {
    if (dontShowAgain) {
      try {
        localStorage.setItem(SCAN_UPPER_JAW_GUIDANCE_PERMANENT_KEY, "1");
      } catch {
        /* ignore */
      }
    }
  ...
  const node = (
    <div
      ...
      style={{ padding: 24 }}
      role="presentation"
      data-node-id="4397:220727"
    >
      <div
        className="pointer-events-auto relative z-10 flex w-full min-w-0 flex-col items-stretch animate-modal-content-enter"
        role="dialog"
        aria-modal="false"
        aria-labelledby="scan-upper-jaw-guidance-title"
        data-node-id="I4397:220727;4397:215498"
        style={cardStyle}
        onMouseDown={(e) => e.stopPropagation()}
      >
        <div className="flex w-full min-w-0 flex-col gap-6" data-node-id="I4397:220727;4397:215499">
          <div className="flex h-[60px] w-full min-w-0 shrink-0 items-center gap-4" data-node-id="I4397:220727;4397:215501">
            <h2
              id="scan-upper-jaw-guidance-title"
              className="tp-heading-03 max-h-12 min-w-px flex-1 overflow-hidden text-ellipsis text-left text-text-primary"
              data-node-id="I4397:220727;4397:215502"
            >
              Scan Upper Jaw
            </h2>
            <button
              ...
              onClick={handleClose}
              data-node-id="I4397:220727;4397:215684"
            >
          ...
          <div
            ...
            data-node-id="I4397:220727;4397:215506"
          >
            <img
              src={STEPS_DIAGRAM}
              alt=""
          ...
          <div
            ...
            data-node-id="I4397:220727;4397:215589"
          >
            <div
              className="flex size-14 shrink-0 items-center justify-center"
              data-node-id="I4397:220727;4397:215564"
              aria-hidden
            >
              <div className="relative size-[54px] shrink-0" data-node-id="I4397:220727;4397:215565">
                <img
                  src={SALIVA_ICON}
                  alt=""
            ...
            <ul
              ...
              data-node-id="I4397:220727;4397:215505"
            >
          ...
          <div className="flex w-full min-w-0 items-center gap-2" data-node-id="I4397:220727;4397:215507">
